...
Here is [analysis](ALS.md) as [GitHub Document](https://rmarkdown.rstudio.com/github_document_format.html), knitted from [ALS.Rmd](ALS.Rmd), the source [R Markdown](https://rmarkdown.rstudio.com/)
